...
const char* ADAPTIVE_INITIAL_BYTES_PER_PERIOD = "adaptive_initial_bytes_per_period";
const char* ADAPTIVE_MIN_BYTES_PER_PERIOD = "adaptive_min_bytes_per_period";
const char* ADAPTIVE_MAX_BYTES_PER_PERIOD = "adaptive_max_bytes_per_period";
...
const char* ADAPTIVE_FEEDBACK_SLOW_WINDOWS = "adaptive_feedback_slow_windows";
...
const char* ADAPTIVE_VALUE_UTILITY = "ADAPTIVE_VALUE_UTILITY";
